...
export const dummyRafo: Book[] = [
    new Book(
        new ObjectId('6627bab529ef994b226ba808'),
        'The Way of Kings',
    ...
    new Book(
        new ObjectId('6627bab529ef994b226ba809'),
        'Words of Radiance',
    ...
    new Book(
        new ObjectId('6627bab529ef994b226ba80a'),
        'Oathbringer',
    ...
    new Book(
        new ObjectId('6627bab529ef994b226ba80b'),
        'Rhythm of War',
    ...
    new Book(
        new ObjectId('6627bab529ef994b226ba80c'),
        'Edgedancer',
    ...
    new Book(
        new ObjectId('6627bab529ef994b226ba80d'),
        'Dawnshard',
    ...
    new Book(
        new ObjectId('6627bab529ef994b226ba80e'),
    ...
    new Book(
        new ObjectId('6627bab529ef994b226ba80f'),
    ...
    new Book(
        new ObjectId('6627bab529ef994b226ba810'),
    ...
    new Book(
        new ObjectId('6627bab529ef994b226ba811'),
    ...
    new Book(
        new ObjectId('6627bab529ef994b226ba813'),
    ...
    new Book(
        new ObjectId('6627bab529ef994b226ba814'),
    ...
    new Book(
        new ObjectId('6627bab529ef994b226ba815'),
    ...
    new Book(
        new ObjectId('6627bab529ef994b226ba816'),
    ...
    new Book(
        new ObjectId('6627bab529ef994b226ba817'),
        'Warbreaker',
    ...
    new Book(
        new ObjectId('6627bab529ef994b226ba818'),
        'Elantris',
    ...
    new Book(
        new ObjectId('6627bab629ef994b226ba819'),
    ...
    new Book(
        new ObjectId('6627bab629ef994b226ba81a'),
        'The Emperor\'s Soul',
    ...
    new Book(
        new ObjectId('6627bab629ef994b226ba81b'),
        'The Eleventh Metal',
    ...
    new Book(
        new ObjectId('6627bab629ef994b226ba81c'),
    ...
    new Book(
        new ObjectId('6627bab629ef994b226ba81d'),
        'White Sand I',
    ...
    new Book(
        new ObjectId('6627bab629ef994b226ba81e'),
        'White Sand II',
        'The graphic novel "White Sand" is set on the planet Taldain and following the adventures of a young sand master.',
        'Taldain',
        'Taldain System',
    ...
    new Book(
        new ObjectId('6627bab629ef994b226ba81f'),
        'White Sand III',
        'The graphic novel "White Sand" is set on the planet Taldain and following the adventures of a young sand master.',
        'Taldain',
        'Taldain System',
    ...
    new Book(
        new ObjectId('6627bab629ef994b226ba820'),
    ...
    new Book(
        new ObjectId('6627bab629ef994b226ba821'),
        'The Sunlit Man',
